...
# Liquidity Gate - CRITICAL FINDING: $15k threshold, 87% win rate
USE_LIQUIDITY_FILTER = _get_bool("USE_LIQUIDITY_FILTER", True)
MIN_LIQUIDITY_USD = _get_float("MIN_LIQUIDITY_USD", min(
    max(_get_float("MIN_LIQUIDITY_USD_RAW", 15000.0), 15000.0),
    50000.0
))
...
GENERAL_CYCLE_MIN_SCORE = _get_int("GENERAL_CYCLE_MIN_SCORE", 5)  # ADJUSTED
